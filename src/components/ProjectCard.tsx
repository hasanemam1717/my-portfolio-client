...
const ProjectCard = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-black to-[#4c1d95] my-20 py-18 text-white">
      ...
      <div className="max-w-7xl  mx-auto space-y-8 md:space-y-16 px-6">
        {projects.map((project, index) => (
          ...
          >
            {/* Text Content */}
            <div className="flex-1 space-y-4 border border-gray-100/30 p-2 lg:p-4 rounded-md">
